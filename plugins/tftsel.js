...
let handler = async(m, { conn, usedPrefix, command, text, }) => {
  ...
  let res = await fetch(`https://api.tokovoucher.id/produk/code?member_code=M230129SGPI6006LU&signature=440c61499871dc1c4c409699c05e0074&kode=tfs`)
...
HARGA ${json.data[27].price} \n
CODE ${json.data[28].code}
NAMA ${json.data[28].nama_produk}
STATUS ${json.data[28].status === 0 ? "Gangguan" : "Aktif"}
HARGA ${json.data[28].price} \n
CODE ${json.data[29].code}
NAMA ${json.data[29].nama_produk}
STATUS ${json.data[29].status === 0 ? "Gangguan" : "Aktif"}
HARGA ${json.data[29].price} \n
CODE ${json.data[30].code}
NAMA ${json.data[30].nama_produk}
STATUS ${json.data[30].status === 0 ? "Gangguan" : "Aktif"}
HARGA ${json.data[30].price} \n
CODE ${json.data[31].code}
NAMA ${json.data[31].nama_produk}
STATUS ${json.data[31].status === 0 ? "Gangguan" : "Aktif"}
HARGA ${json.data[31].price} \n
CODE ${json.data[32].code}
NAMA ${json.data[32].nama_produk}
STATUS ${json.data[32].status === 0 ? "Gangguan" : "Aktif"}
HARGA ${json.data[32].price} \n
