...
TOP UP? GAS TERUSS`;
  ...
  setTimeout(async function () {
    let res = await fetch(
      `https://api.tokovoucher.id/v1/transaksi?ref_id=JAVAN-${refid}-2&produk=sp5&tujuan=1646&secret=d975e3fcf109c81af68620f21f8d193e1e4dbf2b6a5858b1f6a8bd202eb8a87c&member_code=M230129SGPI6006LU`
    );
